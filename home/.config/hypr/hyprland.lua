...
hl.bind("SUPER + S", hl.dsp.exec_cmd(ui .. " /usr/lib/launcher/launcher.so toggle"))
hl.bind("SUPER + P", hl.dsp.exec_cmd(ui .. " /usr/lib/panel/panel.so toggle"))
...
hl.bind("mouse:276", function()
	...
	hl.dispatch(hl.dsp.layout(cycleForward and "move +col" or "move -col"))
	cycleForward = not cycleForward
end)
